...
def pop_next_codon(sequence):
    ...
    Returns a tuple of a string of the first three bases and a string of the remaining sequence.
    """
    codon = sequence[0:3]
...
def get_all_translations(rna_sequence, genetic_code):
    ...
    """
    rna_sequence = rna_sequence.upper()
    numberobases = len(rna_sequence)
    last_codon_index = numberobases - 3
...
if __name__ == '__main__':
    ...
    if longest_peptide == "MYWHATAPYTHQNISTA":
        sys.stdout.write("get itttt girl.\n")
